<form method="POST" action="{{ $feed->id ? route('feeds.update', $feed) : route('feeds.store') }}">
	...
	<h2 class="text-base font-semibold leading-7 text-gray-900 dark:text-gray-50">Feed Information</h2>
	<p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-200 mb-8">Settings for fetching the RSS feed.</p>
	<div class="flex flex-col gap-8">
		<!-- Feed friendly name input -->
		<div class="max-w-2xl w-full">
			<label for="friendly_name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-50">Feed Name</label>
			<div class="mt-2">
			...
			<p class="mt-2 text-sm text-gray-500 dark:text-gray-300" id="friendly_name-description">Enter a name for this RSS feed.</p>
			@error('friendly_name')
		...
		<!-- Feed URL input -->
		<div class="max-w-2xl w-full">
			<label for="url" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-50">Link</label>
			<div class="mt-2">
			...
			<p class="mt-2 text-sm text-gray-500 dark:text-gray-300" id="url-description">URL to the RSS feed.</p>
			@error('url')
				<div class="mt-2 text-sm text-red-600">{{ $message }}</div>
			@enderror
		</div>
	...
	<!-- Start UI settings -->
	<h2 class="text-base font-semibold leading-7 text-gray-900 dark:text-gray-50 mt-16">UI Settings</h2>
	<p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-200 mb-8">Customize how the feeed appears in FeederRSS.</p>
	<div class="flex flex-col gap-8">
		<!-- Show HTML -->
		<div class="relative flex items-start">
			...
			<div class="ml-3 text-sm leading-6">
				<label for="setting_show_html" class="font-medium text-gray-900 dark:text-gray-50">Show HTML</label>
				<p id="setting_show_html-description" class="text-gray-500 dark:text-gray-300">If enabled, rich HTML content will be
					displayed.
		...
		<div class="relative flex items-start">
			...
			<div class="ml-3 text-sm leading-6">
				<label for="setting_show_truncated" class="font-medium text-gray-900 dark:text-gray-50">Trunacte Content</label>
				<p id="setting_show_truncated-description" class="text-gray-500 dark:text-gray-300">When enabled, content will be truncated
					to 3
					lines,
