<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold leading-6 text-gray-900">Feeds</h1>
      <p class="mt-2 text-sm text-gray-700">RSS feeds you've subscribed to.</p>
    </div>
      ...
      <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
          <table class="min-w-full divide-y divide-gray-300">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Last Fetched</th>
          ...
          <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
            {{ $feed->last_fetched ? \Carbon\Carbon::parse($feed->last_fetched)->diffForHumans() : __("Never") }}
          </td>
          <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
            ...
            <a href="{{ route('feeds.edit', $feed) }}" class="text-indigo-600 hover:text-indigo-900">Edit<span
