<div class="w-full divide-y">
  @foreach ($items as $item)
    ...
    <div class="group relative">
      ...
      <div
      class="feed-item mt-2 text-sm leading-6 text-gray-600 prose-sm {{ isset($feed) && $feed->setting_show_truncated ? 'line-clamp-3' : '' }}">
    ...
    <div class="mt-6">
      <a href="{{ $item->link }}"
      class="text-sm rounded border border-gray-900 text-gray-900 hover:bg-gray-800 hover:text-gray-100 transition-all px-3 py-2"
